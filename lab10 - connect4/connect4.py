...
class Joc:
    ...
    def final(self):
        ...
        for lin in self.matr:
            ...
            for juc_curent in s:
                if juc_curent != '#':
                    counter_juc_curent = 0
                    for elem in lin:
                        if juc_curent == elem:
                            counter_juc_curent += 1
                        else:
                            counter_juc_curent = 0
                        if counter_juc_curent == 4:
                            rez = juc_curent
                            return rez
        ...
        for col in range(Joc.NR_COLOANE):
            ...
            for lin in range(Joc.NR_LINII):
                lista_noua.append(self.matr[lin][col])
            s = list(set(lista_noua))
            for juc_curent in s:
                counter_juc_curent = 0
                if juc_curent != '#':
                    for element in lista_noua:
                        if juc_curent == element:
                            counter_juc_curent += 1
                        else:
                            counter_juc_curent = 0
                        if counter_juc_curent == 4:
        ...
        # diagonale \
        # ...
        for linie in range(6):
            for coloana in range(6):
                diagonala = self.get_diagonala(linie, coloana)
        ...
        for linie in range(Joc.NR_LINII-1, -1, -1):
            for coloana in range(Joc.NR_COLOANE-1, -1, -1):
    ...
    def nr_intervale_deschise(self, jucator):
        ...
        # linii
        # ...
        for lin in range(0, Joc.NR_LINII):
            for col in range(0, Joc.NR_COLOANE - 4 + 1):  # 4 = cate conectam
                ok = True
                for coloana in range(col, col+4):
                    if self.matr[lin][coloana] == juc_opus:
                        ok = False
                    if ok:
                        rez += 1
        ...
        # coloane
        # ...
        for col in range(0, Joc.NR_COLOANE):
            for lin in range(0, Joc.NR_LINII - 4 + 1):  # 4 = cate conectam
                ok = True
                for linii in range(lin, lin+4):
                    if self.matr[linii][col] == juc_opus:
                        ok = False
                if ok:
                    rez += 1
