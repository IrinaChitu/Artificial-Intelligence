...
class Joc:
    ...
    def mutari(self, jucator_opus):
        ...
        # ...
        for poz in range(9):
            if self.matr[poz] == '#':           #Joc.Gol
                matr_temp = self.matr.copy();
                matr_temp[poz] = jucator_opus
                l_mutari.append(Joc(matr_temp)) # trebuie de tip
        return l_mutari
    ...
    def linie_deschisa(self, lista, jucator):
        ...
        # ...
        if len(set_deschis) == 1 or ( len(set_deschis) == 2 and '#' in set_deschis):
            return 1
        return 0
