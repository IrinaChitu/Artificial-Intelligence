...
def alpha_beta(alpha, beta, stare):
    ...
    if stare.j_curent == Joc.JMAX:
        ...
        # Pentru fiecare mutare din stare.mutari_posibile aplica alpha beta si actualizeaza scorul, starea aleasa si valoarea beta
        # Daca intervalul devine invalid, intrerup aplicarea alpha beta pe restul mutarilor
        # ...
        for mutare in stare.mutari_posibile:
            raspuns = alpha_beta(alpha, beta, mutare)
...
def main():
    ...
    # ...
    tip = input("Incepe jocul x si 0 (om vs calculator) folosind algoritmul folosind 1 pt alphaBeta sau 2 pt minMax")
